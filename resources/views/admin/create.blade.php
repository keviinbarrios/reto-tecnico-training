...
@section('title', 'Admin Crear naves')
                ...
                <form action="{{route('admin.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="country" placeholder="Ingrese el pais de la nave" class="form-control" id="country">
                        </div>
                        <div class="form-group">
                            <label for="">TIEMPO DE ACTIVIDAD</label>
                            <input type="text" class="form-control" name="uptime" id="uptime"
